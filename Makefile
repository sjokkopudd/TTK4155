...
SOURCE_FILES := main.c uart_driver.c sram_driver.c adc_driver.c joystick_driver.c oled_driver.c oled_menu.c pinball_statemachine.c SPI_driver.c can_communication.c mcp_driver.c
